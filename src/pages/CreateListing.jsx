...
export default function CreateListing() {
  ...
  return (
    ...
    <main className='max-w-md px-2 mx-auto'>
      <h1 className='text-3xl text-center mt-g'>Create a listing</h1>
      <form >
        ...
        className='w-full px-4 py-2 text-sl text-gray-700 
        ...
        <div className='flex space-x-6 mb-6'>
            ...
            <input type="number" id = "bathrooms" value = {bathrooms} min="1" max="50" required  
            className='w-full px-4 py-2 text-sl text-gray-700 
                bg-white border border-gray-300 rounded transition
                duration-150 ease-in-out 
                focus:text-gray-700 focus:bg-white focus:border-slate-600 mb-6' />
        ...
        <textarea 
        type="text" id='address' value={address} onChange={onChange} placeholder='Address' required 
        className='w-full px-4 py-2 text-sl text-gray-700 
        bg-white border border-gray-300 rounded transition
        duration-150 ease-in-out 
        focus:text-gray-700 focus:bg-white focus:border-slate-600 mb-6'/>
        ...
        <textarea 
        type="text" id='description' value={description} onChange={onChange} placeholder='description' required 
        className='w-full px-4 py-2 text-sl text-gray-700 
        bg-white border border-gray-300 rounded transition
        duration-150 ease-in-out 
        focus:text-gray-700 focus:bg-white focus:border-slate-600 mb-6'/>
...
<p className='text-lg font-semibold'>Offer</p>
        ...
        <div className='flex items-center mb-6'>
            <div className=''>
                ...
                <div className='flex w-full justify-center items-center space-x-6'>
                    ...
                    value={regularPrice} onChange={onChange} min = '50'max = "400000000" required className='w-full px-4 py-2 text-xl text-gray-700 bg-white border border-gray-300 rounded transition duration-150
        ...
        {offer &&(
            ...
            <div className=''>
                ...
                <div className='flex w-full justify-center items-center space-x-6'>
                    ...
                    value={discountedPrice} onChange={onChange} min = '50'max = "400000000" required = {offer} className='w-full px-4 py-2 text-xl text-gray-700 bg-white border border-gray-300 rounded transition duration-150
                    ease-in-out focus:text-gray-700 focus:bg-white focus:border-slate-600 text-center'
                    />
                     {type === "rent" &&(
                        <div>
        ...
        hover:shadow-lg focus:bg-blue-700 focus:shadow-lg active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out'>Create Listing</button>
      </form>
    </main>
  )
}
